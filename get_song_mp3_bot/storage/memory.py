...
class MemoryList:
    ...
    def get_urls(self, querty, user_id):
        ...
        self.urls_list[user_id] = [video['webpage_url'] for video in search_results.get('entries', [])]
        self.url_name_video[user_id] = [video['title'] for video in search_results.get('entries', [])]
